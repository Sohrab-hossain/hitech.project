    ...
    <div class="row">
        <div class="col-xl-8 offset-2">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.brand.update',$brand->id) }}" method="post" enctype="multipart/form-data" class="passenger-validation" name="passenger-validation">
                        @csrf
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" value="{{ $brand->name }}" required>
                                        @error('name')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <textarea type="text" class="form-control" name="description" id="description">{{ $brand->description }}</textarea>
